            ...
            <BottomSheet
                ...
                <View style = { styles.statsWrapper as ViewStyle }>
                    <View style = { styles.statsInfoCell as ViewStyle }>
                        <Text style = { [styles.statsTitleText as TextStyle ,{ fontFamily:"IBMPlexSansArabic-Light"}]}>
                            { t('connectionindicator.status') }
                        </Text>
                        <Text style = { [styles.statsInfoText as TextStyle,{ fontFamily:"IBMPlexSansArabic-Light"}] }>
