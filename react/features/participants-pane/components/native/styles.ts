...
export default {
    ...
    participantsBadge: {
        backgroundColor:'#00987E',//BaseTheme.palette.ui03,
        ...
        top: -3,
        textAlign: 'center',
        paddingHorizontal: 2,                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    participantName: {
        color: BaseTheme.palette.text01,
        overflow: 'hidden',                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    moderatorLabel: {
        ...
        paddingLeft: BaseTheme.spacing[3],
        paddingTop: BaseTheme.spacing[1],                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    lobbyListDescription: {
        ...participantListDescription,                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    contextMenuItemText: {
        ...contextMenuItemText,
        marginLeft: BaseTheme.spacing[3],                        fontFamily:"IBMPlexSansArabic-Light"
