        ...
        return (
            <BottomSheet
                ...
                <View style = { styles.contextMenuItem as ViewStyle }>
                    <Text style = { [styles.contextMenuItemText as ViewStyle,{fontFamily:"IBMPlexSansArabic-Light"}] }>
        ...
        return (
            <View
                ...
                <Avatar
                    ...
                    size = { AVATAR_SIZE } />
                <Text style = { [styles.participantNameLabel as TextStyle,{fontFamily:"IBMPlexSansArabic-Light"}] }>
                    { participantName }
                </Text>
            </View>
        );
