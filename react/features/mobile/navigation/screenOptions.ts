...
export const chatTabBarOptions = {
    ...
    tabBarIndicatorStyle: {
        backgroundColor:'#00987E',// BaseTheme.palette.link01Active
    },
    tabBarStyle: {
        backgroundColor: '#001210',//BaseTheme.palette.ui01,
    ...
    TabBarActiveBackgroundColor: '#00987E',
};
...
export const preJoinScreenOptions = {
    gestureEnabled: false,
    headerStyle: {
        backgroundColor:"#001412"// BaseTheme.palette.ui01
    },
    headerTitleStyle: {
        color: BaseTheme.palette.text01,
        fontFamily: 'IBMPlexSansArabic-Light'
