...
export default {
    ...
    gavatarMessageContainer: {
        ...
        ...BaseTheme.typography.bodyShortRegular, fontFamily:"IBMPlexSansArabic-Light"
    },
    ...
    displayName: {
        ...
        position: 'relative', fontFamily:"IBMPlexSansArabic-Light"
    },
    ...
    formSectionTitleText: {
        ...
        color: BaseTheme.palette.text02,
        marginHorizontal: BaseTheme.spacing[4],
        marginVertical: BaseTheme.spacing[3], fontFamily:"IBMPlexSansArabic-Light"
    },
    ...
    languageText: {
        ...BaseTheme.typography.bodyShortRegularLarge,
        color: BaseTheme.palette.text01,
        marginHorizontal: BaseTheme.spacing[2], fontFamily:"IBMPlexSansArabic-Light"
    },
