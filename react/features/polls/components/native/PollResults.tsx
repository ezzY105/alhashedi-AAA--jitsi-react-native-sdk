...
const PollResults = (props: AbstractProps) => {
    ...
    const renderHeader = (answer: string, percentage: number, nbVotes: number) => (
        <View style={resultsStyles.answerHeader as ViewStyle}>
            <Text style={[resultsStyles.answer as TextStyle, {
                fontFamily: "IBMPlexSansArabic-Light"
            }]}>{answer}</Text>
            <View>
                <Text style={[resultsStyles.answer as TextStyle, {
                    fontFamily: "IBMPlexSansArabic-Light"
                }]}>({nbVotes}) {percentage}%</Text>
            </View>
        </View>
    );
    ...
    return (
        <View>
            <Text
                id='question-text'
                style={[dialogStyles.questionText as TextStyle,{                        fontFamily:"IBMPlexSansArabic-Light"
}]} >{question}</Text>
            <Text
                id='poll-owner-text'
                style={[dialogStyles.questionOwnerText as TextStyle,{                        fontFamily:"IBMPlexSansArabic-Light"
}]} >
