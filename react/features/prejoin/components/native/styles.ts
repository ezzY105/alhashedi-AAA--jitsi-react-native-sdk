...
export const preJoinStyles = {
    ...
    errorContainer: {
        ...
        overflow: 'visible',
        wordBreak: 'normal',
        width: 352,                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    error: {
        ...
        textAlign: 'center',                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    displayRoomNameBackdrop: {
        ...
        opacity: 0.7,
        paddingHorizontal: BaseTheme.spacing[3],
        paddingVertical: BaseTheme.spacing[1],                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    recordingWarningText: {
        color: BaseTheme.palette.text03,                        fontFamily:"IBMPlexSansArabic-Light"
    ...
    warningText: {
        ...
        color: BaseTheme.palette.text01,
        textAlign: 'center',
        marginBottom: BaseTheme.spacing[4],                        fontFamily:"IBMPlexSansArabic-Light"
