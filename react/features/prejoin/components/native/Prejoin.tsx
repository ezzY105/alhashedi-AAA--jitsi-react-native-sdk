...
const Prejoin: React.FC<IPrejoinProps> = ({ navigation }: IPrejoinProps) => {
    ...
    return (
        <JitsiScreen
           ...
           */ }
            <View style={[
                //contentContainerStyles as ViewStyle
                , {
                ...
                }
                {
                    showDisplayNameError && (
                        <View style={styles.errorContainer as StyleProp<TextStyle>}>
                            <Text style={[styles.error as StyleProp<TextStyle>, { fontFamily: "IBMPlexSansArabic-Light" }]}>
                ...
                <View style={{
                    flexDirection: 'row',
                    alignItems: "center",
                    paddingBottom: 15, marginTop: 20,
                }}>
                    <View style={{
                        height: 15,
                        width: 15,
                        backgroundColor: '#44C266',
